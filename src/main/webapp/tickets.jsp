      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.jsp">Home <i class="fa fa-chevron-right"></i></a></span> <span>Kiểm tra vé <i class="fa fa-chevron-right"></i></span></p>
		...
		<section class="ftco-section">
          ...
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="check-ticket-input-group row">
                <div class="col-md-4">
                  <div class="check-ticket-input">
                    <div class="check-ticket-code">Mã vé</div>
                    <input placeholder="Nhập mã vé" name="ticketCode" type="text" class="ant-input" value="" style="width: 100%; height: 45px; border-radius: 5px;" required="required">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="check-ticket-input">
                    <div class="check-ticket-phone">Số điện thoại</div>
                    <input placeholder="Nhập số điện thoại" name="phoneNumber" type="text" class="ant-input" value="" style="width: 100%; height: 45px; border-radius: 5px;" required="required">                  </div>
                </div>
                <div class="col-md-4">
                  <div class="check-ticket-submit-btn">
                    <button type="submit" class="ant-btn check-ticket-submit-title" style="width: 100%; height: 45px; margin-top: 28px; background-color: rgb(255, 199, 0); border-radius: 5px; text-transform: uppercase; font-weight: bold; color: rgb(72, 72, 72);">
          ...
          <div class="row " style="margin-top:60px ;">
            <div class="col-md-6">
              <div class="check-ticket-step-left">
                ...
                <div class="check-ticket-step-image ">
                  <img src="assets/images/check-ticket-1.png" alt="">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="check-ticket-step-right">
                ...
                <div class="check-ticket-step-image ">
                  <img src="assets/images/check-ticket-2.png" alt="">
                </div>
              </div>
            </div>
          </div>
