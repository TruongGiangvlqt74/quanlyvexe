							...
							<form>
								<div class="form-group">
									...
									<div class="range-input">
										<input id="filterMin" type="range" class="range-min" min="0" max="5000" value="0" step="50">
										<input id="filterMax" type="range" class="range-max" min="0" max="5000" value="500" step="50">
									</div>
									</div>
								</div>
							</form>
